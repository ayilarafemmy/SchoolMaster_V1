<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgotpass_student.aspx.cs" Inherits="pl" %>
...
<head runat="server">
     <meta charset="UTF-8">
  <title>School Master - Student Forgot Password </title>
...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
		<form id="form1" runat="server">
            ...
            <asp:TextBox ID="TextBox4" runat="server" placeholder="Student ID" TextMode="Number"></asp:TextBox><br />

            <asp:TextBox ID="TextBox1" runat="server" placeholder="Parent Email" TextMode="Email"></asp:TextBox>
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				...
				<h1>Dear Parent</h1>
				<p>Kindly Enter the 6-Digit code sent to your email and New Password</p>
                    Code
