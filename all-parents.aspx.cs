...
public partial class all_parents : System.Web.UI.Page
{
    ...
    {
        string qqy = "select PID,First_Name,Last_Name,Gender,Relationship,Religion,email,Phone,Alternate_Phone,Full_Address,Comments,Identity_Upload,Capture_Date,Capture_By,FirstLogin from D_Parents where First_Name like '%"+TextBox1.Text+ "%' or Last_Name like '%" + TextBox1.Text + "%' OR email like '%" + TextBox1.Text + "%' OR PID like '%" + TextBox1.Text + "%' OR Phone like '%" + TextBox1.Text + "%'";
        GridviewBind(qqy);
        ...
        if(GridView1.Rows.Count ==0)
        {
            ...
            meta.Content = "0;url=all-parents.aspx";
