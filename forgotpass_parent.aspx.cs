...
public partial class pl : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string tiwa = "Update D_Parents set Password='" + TextBox3.Text+ "' where email='"+ Label5.Text+ "'";
            insertRecord(tiwa);
            ...
            meta.Content = "0;url=parent.aspx";
        ...
        protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            cmd.CommandText = "select * from D_Parents where Email='" + TextBox1.Text + "'";
            cmd.Connection = con;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (sendmail == "Yes")
                {
                    ...
                    string StaffMail = "ParentID: "+ Label2.Text + ""+Environment.NewLine+"Dear " + Label3.Text + "," + Environment.NewLine + "" + Environment.NewLine + "You have Successfully initiated a Password reset on " + Institution + " App" + Environment.NewLine + " " + Environment.NewLine + " Code is: "+ Label6.Text + " ";
            ...
            else
            {
                ...
                HtmlMeta meta = new HtmlMeta();
                meta.HttpEquiv = "Refresh";
                meta.Content = "1;url=  forgotpass_parent.aspx";
                this.Page.Controls.Add(meta);
            }
