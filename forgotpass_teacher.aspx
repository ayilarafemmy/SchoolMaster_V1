<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgotpass_teacher.aspx.cs" Inherits="pl" %>
...
<head runat="server">
     <meta charset="UTF-8">
  <title>School Master - Teacher Forgot Password </title>
	...
	<div class="form-container sign-in-container">
		<form id="form1" runat="server">
            ...
            <asp:Button ID="Button1" runat="server" Text="Get Reset Code" CssClass="ghost" OnClick="Button1_Click" BackColor="#FFA601" />
            	<a href="teacher.aspx">Back To Login!</a>
