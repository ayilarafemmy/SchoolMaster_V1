...
public partial class all_subject : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "insert into D_Subjects (Subject,Subject_Area,Class,Create_Date,Create_By,ClassID) values ('"+TextBox1.Text+"','"+DropDownList1.SelectedItem.Text+"','"+DropDownList2.SelectedItem.Text+"','"+DateTime.Now.ToString("dd/MMM/yyyy")+"','"+Session["StaffID"].ToString()+"','"+ DropDownList2.SelectedValue+ "')";
        insertRecord(query);
