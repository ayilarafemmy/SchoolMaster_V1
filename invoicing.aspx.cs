...
public partial class Admin_Students : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        {
            con.Open();
            string com = "Select TermID,Concat(Year,' ',Term, ' Term') as Term from D_Term where Active ='Y'";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new System.Data.DataTable();
            adpt.Fill(dt);
            DropDownList4.DataSource = dt;
            DropDownList4.DataBind();
            DropDownList4.DataTextField = "Term";
            DropDownList4.DataValueField = "TermID";
            DropDownList4.DataBind();
            DropDownList4.Items.Insert(0, new ListItem("Select Term", "0"));
            con.Close();
        }
    }
    protected void BindGrid1()
    {
        ...
        {
            con.Open();
            string com = "select PPID,Purpose from D_PaymentPurpose where PaymentType='IN'";
            SqlDataAdapter adpt = new SqlDataAdapter(com, con);
            DataTable dt = new System.Data.DataTable();
            adpt.Fill(dt);
            DropDownList3.DataSource = dt;
            DropDownList3.DataBind();
            DropDownList3.DataTextField = "Purpose";
            DropDownList3.DataValueField = "PPID";
            DropDownList3.DataBind();
            DropDownList3.Items.Insert(0, new ListItem("Select Purpose", "0"));
            con.Close();
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox("Kindly Select Purpose");
            DropDownList3.BorderColor = Color.Red;
            return;
        }
        if (DropDownList5.SelectedItem.Text == "Select Quantity")
        {
            MessageBox("Kindly Select Quantity");
            DropDownList5.BorderColor = Color.Red;
            return;
        }
        if (TextBox7.Text == "")
        {
            MessageBox("Amount Cannot be empty");
            return;
        }
        if(TextBox3.Text.Length < 10)
        {
            MessageBox("Kindly provide detailed desceription");
            return;
        }
        ...
        DropDownList5.SelectedItem.Text = "Select Quantity";
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Label4.Text = DropDownList4.SelectedValue + "_" + DropDownList1.SelectedValue + "_" + DropDownList2.SelectedValue + "_" + DateTime.Now.ToString("ddMMMyy");
        }
    }
    ...
    protected void DropDownList5_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            if(TextBox7.Text =="")
            {
                MessageBox("Amount Can not be Empty");
                return;
            }
            else
            {
                int amoutn = int.Parse(TextBox7.Text);
                int qtty = int.Parse(DropDownList5.SelectedValue);
                int line = amoutn * qtty;
                TextBox4.Text = line.ToString();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox2.Text == "")
        {
            MessageBox("Kindly generate code");
            return;
        }
        //   get parent details
        ...
        conk.Open();
        cmdk.CommandText = "SELECT sum(CAST(amount AS int)) as Amount FROM D_LineItem where InvoiceID='" + Label4.Text + "'";
