    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                Label1.Visible = true;
                Label1.ForeColor = Color.Red;
                Label1.Text = "Kindly note that your registered Email is your user name...Your Username and or Password is incorrect and you must be assigned a class";
