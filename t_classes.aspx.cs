...
public partial class t_attendance : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string query = "select a.PID,a.Session,b.Subject,a.Day,a.Period,c.FClass as Class from D_Period a, D_Subjects b, D_Classes c, D_Session d where a.Subject = b.SubjectID and a.ClassID = c.ClassID and a.Teacher='"+Session["StaffID"].ToString()+"' and a.SessionID = d.SessionID and d.Status='Open'";
            GridviewBind(query);
        }
    ...
    protected void BindGrid()
    {
        ...
        {
            con.Open();
            string com = "select Concat(Year,' ',Period) as Session,SessionID from D_Session where status='Closed'";
