...
public partial class Admin_Students : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            BindGrid();
            BindGrid1();
            string query = "select LID,MaterialType,Material,Subject,Uploadedby,Class,Description,Doc,filetype,Downloadcount,Expirydate from D_LMS order by LID desc";
            GridviewBind(query);
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        meta.Content = "1;url=Admin_LMS.aspx";
    ...
    {
        string qqy = "select LID,MaterialType,Material,Subject,Uploadedby,Class,Description,Doc,filetype,Downloadcount,Expirydate from D_LMS where Material like '%" + TextBox2a.Text + "%' or Subject like '%" + TextBox2a.Text + "%' OR Class like '%" + TextBox2a.Text + "%'";
        GridviewBind(qqy);
