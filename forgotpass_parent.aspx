<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgotpass_parent.aspx.cs" Inherits="pl" %>
...
<head runat="server">
     <meta charset="UTF-8">
  <title>School Master - Parent Forgot Password </title>
	...
	<div class="form-container sign-in-container">
		<form id="form1" runat="server">
            ...
            <asp:Button ID="Button1" runat="server" Text="Get Reset Code" CssClass="ghost" OnClick="Button1_Click" BackColor="#FFA601" />
            	<a href="parent.aspx">Back To Login!</a>
