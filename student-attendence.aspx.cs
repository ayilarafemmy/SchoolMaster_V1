...
public partial class all_subject : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string query = "select a.Name,a.Status,a.Date,a.time,a.SID as StudentID,b.FClass as Class,Concat(c.FirstName,' ',c.LastName) as Staff from D_Attendance a, D_Classes b, D_Staff c where a.Class = b.classID and a.Takenby=c.staffID order by a.AIDD desc";
            GridviewBind(query);
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        meta.Content = "0;url=student-attendence.aspx";
