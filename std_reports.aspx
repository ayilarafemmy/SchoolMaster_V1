<%@ Page Title="" Language="C#" MasterPageFile="~/nstudent.master" AutoEventWireup="true" CodeFile="std_reports.aspx.cs" Inherits="t_attendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="breadcrumbs-area">
          ...
          <asp:Button ID="Button1" runat="server" Text="View Report" CssClass="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" OnClick="Button1_Click" visible="false" />
