<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Staff-details.aspx.cs" Inherits="parents_details" %>
                       ...
                       <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></td>
                               ...
                               <asp:Label ID="Label8" runat="server" Text="Label"></asp:Label></td>
                                            ...
                                            <tr>
                                                <td>Role 2:</td>
                                                <td class="font-medium text-dark-medium">
                                                    <asp:TextBox ID="TextBox5" runat="server" CssClass="auto-style3"></asp:TextBox></td>
                                            </tr>
